    ...
    return <div style={{
      ...
      <div style={{display:"flex"}}>
        ...
        <div style={{display:"flex", flexDirection:"column", marginLeft:"0.5rem"}}>
          <span style={{color:data.color, fontSize:"1.125rem",lineHeight:"1.75rem",fontWeight:700}}>{data.name + "-vitamiini"}</span>
